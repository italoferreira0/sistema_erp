...
class Tasks(Base):
    ...
    def get(self, request):
        ...
        tasks = Task.object.filter(enterprise_id=enterprise_id).all() #Pegar todas as tarefas de uma empresa
    ...
    def post(self, request):
        ...
        if not title or len(title) > 125:
            raise APIException("Envie um titulo válido, para essa tarefa.")
